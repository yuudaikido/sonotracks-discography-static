...
### Docs
- 公式 API ガイド <https://sono-tracks.com/api-guide> への参照を追加（README「API について」節冒頭）
- 「APIの利用頻度について」節に CDN 約10分キャッシュの注記を追加（詳細は公式ガイド参照）
- トラブルシュートに「同期したのに新作が出ない → 約10分のキャッシュ」を追記
